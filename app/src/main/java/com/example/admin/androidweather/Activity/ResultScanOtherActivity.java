...
public class ResultScanOtherActivity extends AppCompatActivity {
   ...
   // EditText editText_0 = (EditText)findViewById(R.id.edittext_name);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipDialog = new QMUITipDialog.Builder(ResultScanOtherActivity.this)
                .setIconType(QMUITipDialog.Builder.ICON_TYPE_LOADING)
                .setTipWord("正在加载")
                .create();

        tipDialog_1 = new QMUITipDialog.Builder(ResultScanOtherActivity.this)
                .setIconType(QMUITipDialog.Builder.ICON_TYPE_SUCCESS)
                .setTipWord("发送成功")
                .create();

        tipDialog_2= new QMUITipDialog.Builder(ResultScanOtherActivity.this)
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(ResultScanOtherActivity.this ,ScanActivity.class);
...
//                                Toast.makeText(ResultScanOtherActivity.this,result,Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
